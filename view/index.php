   ...
   <div class="container formulario">
                ...
                <div class="row">
                    <fieldset class="col-xs-10 col-xs-offset-1">
                        ...
                        <form class="form horinzotal">
                            
                            <div class="form-group">
                                <label class="col-xs-12" for="usuario"><h4>User</h4></label>
                                <div class="col-xs-10 col-xs-offset-1">
                                    <input type="text" name="" id="usuario" class="form-control formulario_input"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-primary center-block">Aceptar</button>
                            </div>
